...
- Users can optionally enable a chapter gallery view that shows the latest saved image for every verse in the current chapter.
...
- The optional chapter gallery uses a chapter-scoped query to fetch the latest saved image per verse and falls back to placeholders for verses without art.
